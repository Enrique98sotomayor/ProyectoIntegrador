...
Route::get('/logindocente', [LoginController::class,'indexdocente'])->name('logindocente');
Route::get('/loginsecretaria', [LoginController::class,'indexsecretaria'])->name('loginsecretaria');
